                ...
                <div class="p-6 bg-white dark:bg-gray-800">
                    ...
                    <form action="{{ route('funcionarios.update', $funcionario->id) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="telefone" id="telefone" class="form-input mt-1 block w-full" value="{{ $funcionario->telefone }}" required>
                        </div>
                        <div class="mb-4">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="date" name="data" id="data" class="form-input mt-1 block w-full" value="{{ $funcionario->data }}" required>
                        </div>
